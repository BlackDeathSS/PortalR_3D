...
/* The original compact 3-by-5 font, extended for "FPS nnn.n"/"FREECAM". */
...
/* Direct bit-to-palette lookups avoid division/shift helpers in the hot loop. */
...
static void draw_hud(
    ...
    /* Only obscure the two text bounds; the presenter refreshes everything else. */
    for (row = 0; row < 8; ++row) {
