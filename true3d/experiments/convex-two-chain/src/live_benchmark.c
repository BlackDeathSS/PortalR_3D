...
static const LiveSection live_sections[LIVE_SECTION_COUNT] = {
    {"OPEN_YAW", LIVE_SECTION_TURN},
    {"PITCH_SWEEP", LIVE_SECTION_PITCH},
    {"PORTAL_FAR", LIVE_SECTION_PORTAL_VIEW | LIVE_SECTION_LOD},
    {"PORTAL_NEAR", LIVE_SECTION_PORTAL_VIEW | LIVE_SECTION_LOD},
    ...
    {"RETURN_UP", LIVE_SECTION_PORTAL_VIEW | LIVE_SECTION_PORTAL_CROSS |
        LIVE_SECTION_FREECAM | LIVE_SECTION_STRESS},
    {"LOD_RETREAT", LIVE_SECTION_PORTAL_VIEW | LIVE_SECTION_LOD |
        LIVE_SECTION_FREECAM},
    {"LOD_APPROACH", LIVE_SECTION_PORTAL_VIEW | LIVE_SECTION_PORTAL_CROSS |
        LIVE_SECTION_LOD | LIVE_SECTION_FREECAM | LIVE_SECTION_STRESS},
    {"FREECAM_YAW", LIVE_SECTION_TURN | LIVE_SECTION_FREECAM},
    {"FREECAM_3D", LIVE_SECTION_PITCH | LIVE_SECTION_FREECAM |
        LIVE_SECTION_VERTICAL | LIVE_SECTION_STRESS}
};
...
static uint8_t live_run_route(
    ...
    LiveController controller;
    uint32_t slowest_render[LIVE_SECTION_COUNT] = {0};
    ...
    *crossings = 0;
    ...
    while (frame < LIVE_FRAME_COUNT) {
        ...
        if (render_ticks > slowest_render[section]) {
            slowest_render[section] = render_ticks;
...
static void live_show_result(
    ...
    os_PutStrFull(crossings == 3 ? "3" : "unexpected");
    os_SetCursorPos(5, 0);
