...
/*
 * The root layer is always sampled at full resolution.  Keep this as a
 * separate function so the compiler can fold step=1 and sample_origin=0
 * throughout the scan converter instead of carrying the portal LOD shift
 * through every edge and row.
 */
