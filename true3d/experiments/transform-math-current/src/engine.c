...
static void transform_world_vertices(const Camera *camera) {
    ...
    scale_camera_axis_exact(camera, 0u, extent_x, &edge_x);
    scale_camera_axis_exact(camera, 1u, extent_y, &edge_y);
    scale_camera_axis_exact(camera, 2u, extent_z, &edge_z);
