...
.Lplan_exit_ready:
	...
	/* Opposite-facing portals retain ray, reciprocal, magnitude and steps. */
	ld a, (ix + PLAN_FLAGS)
	and a, 3
	jp z, .Lplan_return
	dec a
...
.Lplan_state_steps:
	/* Rebuild signed strides from the rotated rays, including exact axes. */
	ld hl, 1
	ld a, (_render_ray_state + STATE_RAY_X + 2)
	bit 7, a
