...
; %bb.71:                               ;   in Loop: Header=BB7_69 Depth=1
	ld	c, (ix - 51)                    ; 1-byte Folded Reload
	ld	a, c
	or	a, a
	jp	nz, .LBB7_78
; %bb.72:                               ;   in Loop: Header=BB7_69 Depth=1
	...
	ld	a, l
	dec	a
	ld	(_render_first_portal_runs), a
	ld	a, l
	ld	(_render_first_portal_runs+1), a
	ld	iy, _render_layer_rays
	ld	de, (ix - 30)
	add	iy, de
	ld	a, (iy + 53)
	ld	(_render_first_portal_runs+2), a
	ld	a, (iy + 64)
	ld	b, 2
	call	__bshl
	ld	e, (iy + 50)
	...
	ld	bc, 0
	ld	c, l
	ld	hl, _render_layer_transform_flags
	add	hl, bc
	ld	a, (hl)
	ld	(_render_first_portal_runs+9), a
	xor	a, a
	ld	(_render_first_portal_runs+3), a
	ld	(_render_first_portal_runs+5), a
	ld	a, e
	cp	a, 2
	jp	nc, .LBB7_81
; %bb.73:                               ;   in Loop: Header=BB7_69 Depth=1
	ld	a, (iy + 49)
	ld	(_render_first_portal_runs+4), a
	ld	a, e
	or	a, a
	ld	c, -1
	jr	z, .LBB7_75
; %bb.74:                               ;   in Loop: Header=BB7_69 Depth=1
	ld	c, 0
	.local	.LBB7_75
.LBB7_75:                               ;   in Loop: Header=BB7_69 Depth=1
	ld	l, (iy + 48)
	ld	a, c
	rrc	a
	sbc	a, a
	...
	ld	d, -1
	jr	z, .LBB7_77
; %bb.76:                               ;   in Loop: Header=BB7_69 Depth=1
	ld	d, 0
	.local	.LBB7_77
.LBB7_77:                               ;   in Loop: Header=BB7_69 Depth=1
	ld	a, 1
	ld	b, a
	ld	a, e
	or	a, b
	...
	ld	e, a
	ld	a, h
	ld	(_render_first_portal_runs+6), a
	ld	a, l
	ld	(_render_first_portal_runs+7), a
	ld	a, e
	ld	(_render_first_portal_runs+8), a
	xor	a, a
	jp	.LBB7_86
	.local	.LBB7_78
.LBB7_78:                               ;   in Loop: Header=BB7_69 Depth=1
	ld	de, 0
	ld	e, c
	push	de
	pop	hl
	...
	push	hl
	pop	bc
	ld	iy, _render_first_portal_runs
	add	iy, bc
	ld	a, (iy + 1)
	ld	bc, 0
	ld	c, a
	...
	sbc	hl, bc
	jr	nz, .LBB7_87
; %bb.79:                               ;   in Loop: Header=BB7_69 Depth=1
	lea	bc, iy + 0
	ld	iy, (ix - 42)
	ld	l, (iy + 53)
	push	bc
	...
	cp	a, l
	jr	nz, .LBB7_88
; %bb.80:                               ;   in Loop: Header=BB7_69 Depth=1
	ld	a, (ix - 45)
	ld	(iy + 1), a
	jp	.LBB7_99
	.local	.LBB7_81
...
; %bb.84:                               ;   in Loop: Header=BB7_69 Depth=1
	ld	d, 0
	.local	.LBB7_85
.LBB7_85:                               ;   in Loop: Header=BB7_69 Depth=1
	ld	a, 1
	ld	b, a
	ld	a, e
	or	a, b
	...
	ld	a, iyl
	.local	.LBB7_86
.LBB7_86:                               ;   in Loop: Header=BB7_69 Depth=1
	ld	(_render_first_portal_runs+10), a
	push	af
	ld	a, iyl
	ld	(ix - 51), a                    ; 1-byte Folded Spill
	pop	af
...
.LBB7_87:                               ;   in Loop: Header=BB7_69 Depth=1
	...
	ld	l, (iy + 53)
	.local	.LBB7_88
.LBB7_88:                               ;   in Loop: Header=BB7_69 Depth=1
	ld	(ix - 63), l
	inc	(ix - 51)
	ex	de, hl
	ld	bc, 11
	...
	cp	a, 2
	jr	nc, .LBB7_94
; %bb.89:                               ;   in Loop: Header=BB7_69 Depth=1
	ld	iy, (ix - 42)
	ld	a, (iy + 49)
	push	hl
	pop	iy
	...
	ld	c, -1
	jr	z, .LBB7_91
; %bb.90:                               ;   in Loop: Header=BB7_69 Depth=1
	ld	c, 0
	.local	.LBB7_91
.LBB7_91:                               ;   in Loop: Header=BB7_69 Depth=1
	...
	ld	h, -1
	jr	z, .LBB7_93
; %bb.92:                               ;   in Loop: Header=BB7_69 Depth=1
	ld	h, 0
	.local	.LBB7_93
.LBB7_93:                               ;   in Loop: Header=BB7_69 Depth=1
	...
	jr	.LBB7_99
	.local	.LBB7_94
.LBB7_94:                               ;   in Loop: Header=BB7_69 Depth=1
	ld	iy, (ix - 42)
	ld	a, (iy + 48)
	push	hl
	pop	iy
	...
	ld	c, -1
	jr	z, .LBB7_96
; %bb.95:                               ;   in Loop: Header=BB7_69 Depth=1
	ld	c, 0
	.local	.LBB7_96
.LBB7_96:                               ;   in Loop: Header=BB7_69 Depth=1
	ld	iy, (ix - 42)
	ld	l, (iy + 49)
	ld	a, c
	rrc	a
	...
	ld	h, -1
	jr	z, .LBB7_98
; %bb.97:                               ;   in Loop: Header=BB7_69 Depth=1
	ld	h, 0
	.local	.LBB7_98
.LBB7_98:                               ;   in Loop: Header=BB7_69 Depth=1
	ld	d, 1
	ld	a, e
	or	a, d
	ld	e, a
	...
	ld	(iy + 10), 1
	.local	.LBB7_99
.LBB7_99:                               ;   in Loop: Header=BB7_69 Depth=1
	ld	c, (ix - 54)                    ; 1-byte Folded Reload
	ld	iy, (ix - 16)
	ld	de, (ix - 39)
	add	iy, de
	ld	a, (ix - 12)
	...
	ld	l, a
	bit	0, l
	ld	b, (ix - 57)                    ; 1-byte Folded Reload
	jr	z, .LBB7_101
; %bb.100:                              ;   in Loop: Header=BB7_69 Depth=1
	ld	e, -80
	ld	a, c
	add	a, e
	ld	c, a
	.local	.LBB7_101
.LBB7_101:                              ;   in Loop: Header=BB7_69 Depth=1
	ld	a, l
	and	a, 1
	ld	de, 0
	ld	e, a
	...
	ld	(ix - 54), c
	jr	z, .LBB7_103
; %bb.102:                              ;   in Loop: Header=BB7_69 Depth=1
	ld	e, -80
	ld	a, b
	add	a, e
	ld	b, a
	.local	.LBB7_103
.LBB7_103:                              ;   in Loop: Header=BB7_69 Depth=1
	ld	(ix - 57), b
	ld	a, l
	and	a, 1
	ld	de, 0
...
.LBB7_104:
	ld	bc, 0
	ld	c, (ix - 51)                    ; 1-byte Folded Reload
	ld	iy, _render_layer_transform_plan
	lea	hl, iy + 6
	ld	(ix - 39), hl
	.local	.LBB7_105
...
; %bb.106:                              ;   in Loop: Header=BB7_105 Depth=1
	...
	call	__imulu
	ex	de, hl
	ld	hl, _render_first_portal_runs
	push	hl
	pop	iy
	add	iy, de
	ld	hl, (iy + 3)
	ld	de, (iy + 6)
	ld	bc, (iy + 9)
	ld	(_render_layer_transform_plan), hl
	ld	(_render_layer_transform_plan+3), de
	ld	hl, (ix - 39)
	ld	(hl), c
	inc	hl
	ld	(hl), b
	...
	ld	c, a
	.local	.LBB7_107
.LBB7_107:                              ;   Parent Loop BB7_105 Depth=1
                                        ; =>  This Loop Header: Depth=2
                                        ;       Child Loop BB7_109 Depth 3
	ld	a, (iy + 1)
	ld	e, a
...
; %bb.108:                              ;   in Loop: Header=BB7_107 Depth=2
	...
	lea	hl, iy + 55
	ld	(ix - 51), hl
	ld	(_render_ray_state+40), hl
	call	_render_asm_transform_ray_predecoded_state
	.local	.LBB7_109
.LBB7_109:                              ;   Parent Loop BB7_105 Depth=1
...
.LBB7_112:                              ;   in Loop: Header=BB7_107 Depth=2
	...
	jp	.LBB7_107
	.local	.LBB7_113
.LBB7_113:                              ;   in Loop: Header=BB7_105 Depth=1
	ld	de, (ix - 33)
	inc	de
	ld	bc, (ix - 36)
	jp	.LBB7_105
...
.Lfunc_end10:
	.size	_fixed_scale_mul, .Lfunc_end10-_fixed_scale_mul
                                        ; -- End function
	.section	.text._render_layer_finish_hit,"ax",@progbits
	.type	_render_layer_finish_hit,@function ; -- Begin function render_layer_finish_hit
_render_layer_finish_hit:               ; @render_layer_finish_hit
; %bb.0:
	ld	hl, -17
	call	__frameset
	ld	iy, (ix + 9)
...
.LBB11_43:
	...
	ld	d, (ix - 14)                    ; 1-byte Folded Reload
	jr	c, .LBB11_45
; %bb.44:
	ld	c, h
	.local	.LBB11_45
...
.LBB11_61:
	...
	.local	.Lfunc_end11
.Lfunc_end11:
	.size	_render_layer_finish_hit, .Lfunc_end11-_render_layer_finish_hit
                                        ; -- End function
...
_map_row_offsets:
	...
	.section	.bss._render_layer_transform_plan,"aw",@nobits
	.balign	1
	.globl	_render_layer_transform_plan
_render_layer_transform_plan:
	.zero	8
...
_grid_segments:
	...
	.section	.bss._render_layer_rays,"aw",@nobits
	.balign	1
	.local	_render_layer_rays
_render_layer_rays:
	.zero	6400

	.section	.bss._render_first_portal_runs,"aw",@nobits
	.balign	1
	.local	_render_first_portal_runs
_render_first_portal_runs:
	.zero	880
...
_portal_visit_bits:
	...
	.section	.rodata._render_layer_transform_flags,"a",@progbits
	.balign	1
	.local	_render_layer_transform_flags
_render_layer_transform_flags:
...
_fps_smoothed_ticks:
	...
	.extern	__lcmpzero
	.extern	_render_asm_transform_ray_predecoded_state
