...
; %bb.39:                               ;   in Loop: Header=BB20_1 Depth=1
	...
	ld	iy, (ix - 43)
	.local	.LBB20_40
.LBB20_40:                              ;   in Loop: Header=BB20_1 Depth=1
...
; %bb.49:                               ;   in Loop: Header=BB20_1 Depth=1
	ld	l, c
	.local	.LBB20_50
.LBB20_50:                              ;   in Loop: Header=BB20_1 Depth=1
	ld	c, (ix - 30)
	ld	b, (ix - 29)
	ld	h, b
	ld	d, b
...
.LBB20_54:                              ;   in Loop: Header=BB20_1 Depth=1
	...
	cp	a, e
	jr	c, .LBB20_56
; %bb.55:                               ;   in Loop: Header=BB20_1 Depth=1
	ld	e, l
	.local	.LBB20_56
.LBB20_56:                              ;   in Loop: Header=BB20_1 Depth=1
	...
	cp	a, c
	jr	c, .LBB20_58
; %bb.57:                               ;   in Loop: Header=BB20_1 Depth=1
	ld	l, c
	.local	.LBB20_58
...
; %bb.64:                               ;   in Loop: Header=BB20_1 Depth=1
	ld	c, iyl
	.local	.LBB20_65
.LBB20_65:                              ;   in Loop: Header=BB20_1 Depth=1
	ld	a, d
	ld	hl, (ix - 16)
	cp	a, l
	jr	c, .LBB20_67
...
.LBB20_71:                              ;   in Loop: Header=BB20_1 Depth=1
	ld	e, (ix - 9)                     ; 1-byte Folded Reload
	.local	.LBB20_72
.LBB20_72:                              ;   in Loop: Header=BB20_1 Depth=1
...
; %bb.76:                               ;   in Loop: Header=BB20_1 Depth=1
	...
	sbc	hl, de
	jr	nc, .LBB20_78
; %bb.77:                               ;   in Loop: Header=BB20_1 Depth=1
	push	bc
	pop	hl
	jr	.LBB20_81
	.local	.LBB20_78
...
.LBB20_82:                              ;   in Loop: Header=BB20_1 Depth=1
	...
	bit	0, a
	jp	z, .LBB20_90
; %bb.83:                               ;   in Loop: Header=BB20_1 Depth=1
	ld	a, (_render_benchmark_category)
	cp	a, 4
	jp	z, .LBB20_90
; %bb.84:                               ;   in Loop: Header=BB20_1 Depth=1
	...
	sbc	hl, de
	jr	nc, .LBB20_86
; %bb.85:                               ;   in Loop: Header=BB20_1 Depth=1
	push	bc
	pop	hl
	jr	.LBB20_89
	.local	.LBB20_86
.LBB20_86:                              ;   in Loop: Header=BB20_1 Depth=1
	ld	de, (-917472)
	push	de
	pop	hl
	or	a, a
	...
	sbc	hl, bc
	jr	nc, .LBB20_88
; %bb.87:                               ;   in Loop: Header=BB20_1 Depth=1
	push	de
	pop	iy
	.local	.LBB20_88
.LBB20_88:                              ;   in Loop: Header=BB20_1 Depth=1
	lea	hl, iy + 0
	.local	.LBB20_89
.LBB20_89:                              ;   in Loop: Header=BB20_1 Depth=1
	ld	(ix - 28), hl
	ld	bc, (_render_benchmark_last)
	ld	e, (ix - 9)                     ; 1-byte Folded Reload
	ld	iy, (ix - 22)
	...
	ld	iy, (ix - 12)
	.local	.LBB20_90
.LBB20_90:                              ;   in Loop: Header=BB20_1 Depth=1
	ld	c, (ix - 1)
	ld	a, (ix - 34)                    ; 1-byte Folded Reload
	cp	a, c
	ld	d, c
	jr	c, .LBB20_92
; %bb.91:                               ;   in Loop: Header=BB20_1 Depth=1
	ld	d, a
	.local	.LBB20_92
.LBB20_92:                              ;   in Loop: Header=BB20_1 Depth=1
	ld	l, (ix - 2)
	ld	a, l
	...
	ld	b, l
	jr	c, .LBB20_94
; %bb.93:                               ;   in Loop: Header=BB20_1 Depth=1
	ld	b, a
	.local	.LBB20_94
.LBB20_94:                              ;   in Loop: Header=BB20_1 Depth=1
	ld	a, d
	cp	a, b
	jp	nc, .LBB20_129
; %bb.95:                               ;   in Loop: Header=BB20_1 Depth=1
	ld	a, l
	sub	a, c
	ld	e, a
	cp	a, 8
	...
	cp	a, l
	jr	nc, .LBB20_103
; %bb.96:                               ;   in Loop: Header=BB20_1 Depth=1
	ld	(ix - 9), b                     ; 1-byte Folded Spill
	ld	a, iyl
	cp	a, e
	ld	bc, (ix - 16)
	jr	c, .LBB20_98
; %bb.97:                               ;   in Loop: Header=BB20_1 Depth=1
	ld	e, iyl
	.local	.LBB20_98
.LBB20_98:                              ;   in Loop: Header=BB20_1 Depth=1
	ld	a, l
	sub	a, h
	ld	h, a
	cp	a, c
	...
	jr	c, .LBB20_100
; %bb.99:                               ;   in Loop: Header=BB20_1 Depth=1
	ld	h, c
	.local	.LBB20_100
.LBB20_100:                             ;   in Loop: Header=BB20_1 Depth=1
	ld	a, h
	cp	a, e
	ex	de, hl
	ld	iyl, d
	ex	de, hl
	jr	c, .LBB20_102
; %bb.101:                              ;   in Loop: Header=BB20_1 Depth=1
	ld	iyl, e
	.local	.LBB20_102
.LBB20_102:                             ;   in Loop: Header=BB20_1 Depth=1
	ld	b, (ix - 9)                     ; 1-byte Folded Reload
	jp	.LBB20_104
	.local	.LBB20_103
.LBB20_103:                             ;   in Loop: Header=BB20_1 Depth=1
	ld	iy, (ix - 16)
	ex	de, hl
	ld	d, iyl
	ex	de, hl
	...
	ld	l, (ix - 13)                    ; 1-byte Folded Reload
	.local	.LBB20_104
.LBB20_104:                             ;   in Loop: Header=BB20_1 Depth=1
	ld	a, l
	cp	a, 5
	jp	z, .LBB20_129
; %bb.105:                              ;   in Loop: Header=BB20_1 Depth=1
	ld	a, b
	sub	a, d
	ld	l, a
	cp	a, 3
	jp	c, .LBB20_129
; %bb.106:                              ;   in Loop: Header=BB20_1 Depth=1
	...
	jr	c, .LBB20_108
; %bb.107:                              ;   in Loop: Header=BB20_1 Depth=1
	ld	c, (ix - 49)                    ; 1-byte Folded Reload
	.local	.LBB20_108
.LBB20_108:                             ;   in Loop: Header=BB20_1 Depth=1
	ld	l, 7
	ld	a, (ix - 47)
	and	a, l
	ld	l, a
	...
	or	a, a
	jp	nz, .LBB20_129
; %bb.109:                              ;   in Loop: Header=BB20_1 Depth=1
	ld	a, (ix - 47)                    ; 1-byte Folded Reload
	cp	a, 8
                                        ; kill: def $a killed $a
	sbc	a, a
	...
	ld	l, h
	jr	nz, .LBB20_111
; %bb.110:                              ;   in Loop: Header=BB20_1 Depth=1
	ld	l, e
	.local	.LBB20_111
.LBB20_111:                             ;   in Loop: Header=BB20_1 Depth=1
	bit	0, a
	jr	nz, .LBB20_113
; %bb.112:                              ;   in Loop: Header=BB20_1 Depth=1
	ld	e, (ix - 30)
	ld	d, (ix - 29)
	ld	e, d
	.local	.LBB20_113
.LBB20_113:                             ;   in Loop: Header=BB20_1 Depth=1
	ld	(ix - 9), b                     ; 1-byte Folded Spill
	ld	(ix - 12), iy
	ld	a, (_render_benchmark_active)
	bit	0, a
	jr	z, .LBB20_115
; %bb.114:                              ;   in Loop: Header=BB20_1 Depth=1
	...
	ld	(iy + 1), b
	.local	.LBB20_115
.LBB20_115:                             ;   in Loop: Header=BB20_1 Depth=1
	ld	c, (ix - 49)
	ld	a, l
	or	a, c
	ld	c, a
...
.LBB20_201:
	...
	.local	.Lfunc_end20
.Lfunc_end20:
	.size	_render_column, .Lfunc_end20-_render_column
                                        ; -- End function
...
; %bb.0:
	...
	.local	.Lfunc_end21
.Lfunc_end21:
	.size	_game_get_render_profile, .Lfunc_end21-_game_get_render_profile
                                        ; -- End function
