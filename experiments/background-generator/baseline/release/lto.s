...
; %bb.27:                               ;   in Loop: Header=BB10_20 Depth=1
	...
	pop	iy
	.local	.LBB10_28
.LBB10_28:                              ;   in Loop: Header=BB10_20 Depth=1
	ld	hl, (ix - 27)
	lea	de, iy + 0
	jp	.LBB10_40
	.local	.LBB10_29
.LBB10_29:                              ;   in Loop: Header=BB10_20 Depth=1
	...
	sbc	hl, de
	jp	nc, .LBB10_33
; %bb.30:                               ;   in Loop: Header=BB10_20 Depth=1
	ld	hl, (ix - 57)
	push	hl
	ld	hl, (ix - 42)
	push	hl
...
; %bb.31:                               ;   in Loop: Header=BB10_20 Depth=1
	lea	de, iy + 0
	.local	.LBB10_32
.LBB10_32:                              ;   in Loop: Header=BB10_20 Depth=1
	ld	(ix - 72), de
	ld	iy, (ix - 27)
	.local	.LBB10_33
...
; %bb.34:                               ;   in Loop: Header=BB10_20 Depth=1
	...
	call	pe, __setflag
	jp	m, .LBB10_36
; %bb.35:                               ;   in Loop: Header=BB10_20 Depth=1
	ld	(ix - 27), iy
	.local	.LBB10_36
...
.LBB10_40:                              ;   in Loop: Header=BB10_20 Depth=1
	ld	bc, (ix - 30)
	.local	.LBB10_41
.LBB10_41:                              ;   in Loop: Header=BB10_20 Depth=1
...
; %bb.44:                               ;   in Loop: Header=BB10_43 Depth=1
	...
	ld	(ix - 51), de
	jp	nz, .LBB10_52
; %bb.45:                               ;   in Loop: Header=BB10_43 Depth=1
	push	bc
	pop	hl
	ld	de, -260
	add	hl, de
...
.LBB10_66:                              ;   in Loop: Header=BB10_63 Depth=1
	...
	ld	iy, (ix - 39)
	jr	z, .LBB10_68
; %bb.67:                               ;   in Loop: Header=BB10_63 Depth=1
	ld	e, -80
	ld	a, h
	add	a, e
	ld	h, a
...
.LBB12_7:
	...
	.local	.Lfunc_end12
.Lfunc_end12:
	.size	_delta_for_component, .Lfunc_end12-_delta_for_component
                                        ; -- End function
...
; %bb.0:
	...
	.local	.Lfunc_end13
.Lfunc_end13:
	.size	_fixed_scale_mul, .Lfunc_end13-_fixed_scale_mul
                                        ; -- End function
...
.LBB14_69:                              ; %.loopexit
	...
	.local	.Lfunc_end14
.Lfunc_end14:
	.size	_render_column, .Lfunc_end14-_render_column
                                        ; -- End function
...
.LBB16_19:
	...
	.local	.Lfunc_end16
.Lfunc_end16:
	.size	_render_frame, .Lfunc_end16-_render_frame
                                        ; -- End function
