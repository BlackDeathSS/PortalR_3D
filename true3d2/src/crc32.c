...
const uint32_t t3d2_crc32_table[256] = {
...
const uint8_t *t3d2_crc32_data;
uint24_t t3d2_crc32_size;
uint32_t t3d2_crc32_result;

void t3d2_crc32_asm(void);

uint32_t t3d2_crc32(const void *data, uint24_t size) {
    t3d2_crc32_data = (const uint8_t *)data;
    t3d2_crc32_size = size;
    t3d2_crc32_asm();
    return t3d2_crc32_result;
}
